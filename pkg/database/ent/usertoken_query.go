...
type UserTokenQuery struct {
	...
	withUser            *UserQuery
	withChildUserTokens *UserTokenQuery
	withParentUserToken *UserTokenQuery
...
// QueryChildUserTokens chains the current query on the "child_user_tokens" edge.
func (utq *UserTokenQuery) QueryChildUserTokens() *UserTokenQuery {
	query := (&UserTokenClient{config: utq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := utq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
// QueryParentUserToken chains the current query on the "parent_user_token" edge.
func (utq *UserTokenQuery) QueryParentUserToken() *UserTokenQuery {
	query := (&UserTokenClient{config: utq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := utq.prepareQuery(ctx); err != nil {
			return nil, err
...
func (utq *UserTokenQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (utq *UserTokenQuery) FirstIDX(ctx context.Context) string {
...
func (utq *UserTokenQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (utq *UserTokenQuery) OnlyIDX(ctx context.Context) string {
...
func (utq *UserTokenQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (utq *UserTokenQuery) IDsX(ctx context.Context) []string {
	ids, err := utq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (utq *UserTokenQuery) Clone() *UserTokenQuery {
	...
	return &UserTokenQuery{
		...
		withChildUserTokens: utq.withChildUserTokens.Clone(),
		withParentUserToken: utq.withParentUserToken.Clone(),
...
// WithChildUserTokens tells the query-builder to eager-load the nodes that are connected to
// the "child_user_tokens" edge. The optional arguments are used to configure the query builder of the edge.
func (utq *UserTokenQuery) WithChildUserTokens(opts ...func(*UserTokenQuery)) *UserTokenQuery {
	query := (&UserTokenClient{config: utq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	utq.withChildUserTokens = query
	return utq
}

// WithParentUserToken tells the query-builder to eager-load the nodes that are connected to
// the "parent_user_token" edge. The optional arguments are used to configure the query builder of the edge.
func (utq *UserTokenQuery) WithParentUserToken(opts ...func(*UserTokenQuery)) *UserTokenQuery {
	query := (&UserTokenClient{config: utq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	utq.withParentUserToken = query
	return utq
}
...
func (utq *UserTokenQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*UserToken, error) {
	var (
		...
		loadedTypes = [3]bool{
			utq.withUser != nil,
			utq.withChildUserTokens != nil,
			utq.withParentUserToken != nil,
		}
	)
	...
	if query := utq.withChildUserTokens; query != nil {
		if err := utq.loadChildUserTokens(ctx, query, nodes,
			func(n *UserToken) { n.Edges.ChildUserTokens = []*UserToken{} },
			func(n *UserToken, e *UserToken) { n.Edges.ChildUserTokens = append(n.Edges.ChildUserTokens, e) }); err != nil {
			return nil, err
		}
	}
	if query := utq.withParentUserToken; query != nil {
		if err := utq.loadParentUserToken(ctx, query, nodes, nil,
			func(n *UserToken, e *UserToken) { n.Edges.ParentUserToken = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (utq *UserTokenQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*UserToken, init func(*UserToken), assign func(*UserToken, *User)) error {
	...
	nodeids := make(map[string][]*UserToken)
	for i := range nodes {
		fk := nodes[i].UserID
...
func (utq *UserTokenQuery) loadChildUserTokens(ctx context.Context, query *UserTokenQuery, nodes []*UserToken, init func(*UserToken), assign func(*UserToken, *UserToken)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(usertoken.FieldParentTokenID)
	}
	query.Where(predicate.UserToken(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(usertoken.ChildUserTokensColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (utq *UserTokenQuery) loadParentUserToken(ctx context.Context, query *UserTokenQuery, nodes []*UserToken, init func(*UserToken), assign func(*UserToken, *UserToken)) error {
	ids := make([]string, 0, len(nodes))
	nodeids := make(map[string][]*UserToken)
	for i := range nodes {
...
func (utq *UserTokenQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(usertoken.Table, usertoken.Columns, sqlgraph.NewFieldSpec(usertoken.FieldID, field.TypeString))
	_spec.From = utq.sql
	...
	if fields := utq.ctx.Fields; len(fields) > 0 {
		...
		if utq.withParentUserToken != nil {
			_spec.Node.AddColumnOnce(usertoken.FieldParentTokenID)
		}
	}
