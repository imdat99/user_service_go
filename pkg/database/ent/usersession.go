...
func (*UserSession) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case usersession.FieldID, usersession.FieldUserID, usersession.FieldSessionToken, usersession.FieldDeviceInfo, usersession.FieldIPAddress, usersession.FieldUserAgent:
...
func (us *UserSession) String() string {
	...
	builder.WriteString(us.SessionToken)
	builder.WriteString(", ")
