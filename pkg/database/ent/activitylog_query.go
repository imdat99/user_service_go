...
func (alq *ActivityLogQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (alq *ActivityLogQuery) FirstIDX(ctx context.Context) string {
...
func (alq *ActivityLogQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (alq *ActivityLogQuery) OnlyIDX(ctx context.Context) string {
...
func (alq *ActivityLogQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (alq *ActivityLogQuery) IDsX(ctx context.Context) []string {
	ids, err := alq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(activitylog.FieldUserID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.ActivityLog.Query().
//		Select(activitylog.FieldUserID).
//		Scan(ctx, &v)
